...
class TestGenerateBudget(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.cost_data = pd.DataFrame({
            ...
            'ngn_cost': [1800, 90000, 1890, 450, 900, 900, 0, 540, 0, 3600, 0, 180, 1350, 4500, 2700]
        })
    ...
    def run_generate_budget(self, mock_read_excel, mock_read_csv):
        ...
        return generate_budget(self.scen_data, self.cost_data, self.settings, self.mock_population_data)
    ...
    def test_output_structure_and_completeness(self):
        ...
        expected_interventions = [
            'itn_campaign', 'itn_routine', 'iptp', 'smc', 'pmc', 'vacc', 'cm_public'
        ]
